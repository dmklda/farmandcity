...
export type SimpleEffectType = 
  ...
  | 'BOOST_ALL_FARMS_MATERIALS_TEMP' | 'BOOST_ALL_CITIES_MATERIALS_TEMP'
  | 'BOOST_ALL_FARMS_POPULATION' | 'BOOST_ALL_CITIES_POPULATION'
...
export interface ConditionalEffect {
  type: 'IF_CITY_EXISTS' | 'IF_FARMS_GE_3' | 'IF_WORKSHOPS_GE_2' | 'IF_MAGIC_EXISTS' | 'IF_WATER_EXISTS' | 'IF_COINS_GE_5' | 'IF_CELESTIAL_FARMS_EXIST' | 'IF_VERTICAL_FARMS_EXIST' | 'IF_HAND_GE_5' | 'IF_HORTA_EXISTS' | 'IF_SACRED_FIELD_EXISTS' | 'IF_SACRED_TAG_EXISTS' | 'IF_CITY_GE_3' | 'IF_POPULATION_GE_2' | 'IF_COINS_GE_10' | 'IF_TEMPLE_EXISTS' | 'FALLBACK';
  effect: SimpleEffect;
